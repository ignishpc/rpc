...
service IKeysModule{
	...
	void sendPairs(1: string host, 2: i32 port, 3: list<i64> keys_id, 4: i64 msg_id) throws (1:IRemoteException.IRemoteException ex),
	void joinPairs(1: list<i64> msg_ids) throws (1:IRemoteException.IRemoteException ex),
