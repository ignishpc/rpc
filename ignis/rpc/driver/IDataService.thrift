...
service IDataService{
	...
	binary takeSample(1: IDataId data, 2: i64 n, 3: bool withRemplacement, 4: i32 seed, 5: bool randomSeed, 6: bool light) throws (1:IRemoteException.IRemoteException ex),
