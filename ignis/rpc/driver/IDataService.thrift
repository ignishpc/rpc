...
service IDataService{
	...
	IDataId flatmap(1: IDataId data, 2: ISourceFunction.ISourceFunction _function) throws (1:IRemoteException.IRemoteException ex),
	IDataId filter(1: IDataId data, 2: ISourceFunction.ISourceFunction _function) throws (1:IRemoteException.IRemoteException ex),
	...
	IDataId streamingFlatmap(1: IDataId data, 2: ISourceFunction.ISourceFunction _function, 3: bool ordered) throws (1:IRemoteException.IRemoteException ex),
	IDataId streamingFilter(1: IDataId data, 2: ISourceFunction.ISourceFunction _function, 3: bool ordered) throws (1:IRemoteException.IRemoteException ex),
