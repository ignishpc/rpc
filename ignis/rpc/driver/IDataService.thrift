...
service IDataService{
	...
	list<binary> takeSample(1: IDataId data, 2: i64 n, 3: bool withRemplacement, 4: i32 seed, 5: bool light) throws (1:IRemoteException.IRemoteException ex),
	list<binary> collect(1: IDataId data, 2: bool light) throws (1:IRemoteException.IRemoteException ex),
