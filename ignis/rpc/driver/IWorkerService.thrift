...
service IWorkerService{
	...
	IDataFrameService.IDataFrameId openPartitionObjectFile(1: IWorkerId id, 2: string path, 3: i64 partitions) throws (1:IDriverException.IDriverException ex),
	IDataFrameService.IDataFrameId openPartitionObjectFileFunction(1: IWorkerId id, 2: ISource.ISource src, 3: string path, 4: i64 partitions) throws (1:IDriverException.IDriverException ex);
}